...
public class App {
    public static void main(String[] args) throws Exception {
     ...
     " indecisa e não sabe se está preparada para enfrentar uma batalha dessa magnitude\n O QUE ELA DEVE FAZER?", 
          "Evitar a batalha", 
          "Lutar mesmo insegura", Clary, scanner);

      Capitulo cap5 = new Capitulo(
        "A GRANDE BATALHA",
         "No clímax da batalha contra os demônios, Clary escolheu não lutar, apesar de amar"+
         "muito Jace. O rapaz lutou sem ajuda da namorada ao lado de seus amigos Caçadores"+
        ...
        " está se aproximando:\n",
          "Lutar ao lado dos cacadores das sombras",
          "Deixar que eles lutem sozinhos", 
          Clary, scanner);
